...
# Рекомендуемый способ открытия файла.
...
# Если в строке адреса обратный слэш, то он воспринимается программой как знак отмены символа.
# Поэтому нужно использовать сырую строку:

source = r'files\iOS\guide\004 files.py'

# Пример сохранения данных в файл при помощи встроенной библиотеки pickle. Сохранение в битовом формате данных.
# Такая запись в файл называется консервацией pickling, а извлечение данных из файла расконсервацией unpickling:
